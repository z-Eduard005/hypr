...
[+] - keyboard language should be every app speciffic
![ ] - recreate obs toogle scripts
![ ] - add apps from hypr ecosystem
  ...
  [ ] - color picker
  [ ] - screenshots util
  [ ] - wifi and bluetooth simple ui managers
  [ ] - night light
![ ] - add gamemode if its really helpfull (also maybe some power-saver mode like in gnome)
![ ] - recreate alt+tab functionallity
![ ] - add some bar (maybe waybar)
  [ ] - active apps
  [ ] - mem temp status
  [ ] - battery percents
  [ ] - wifi
